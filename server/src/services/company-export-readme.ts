...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Paperclip](https://paperclip.inc)");
  lines.push("");
  ...
  lines.push("```");
  lines.push("");
  lines.push("See [Paperclip](https://paperclip.inc) for more information.");
  lines.push("");

  // Footer
  lines.push("---");
  lines.push(`Exported from [Paperclip](https://paperclip.inc) on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
