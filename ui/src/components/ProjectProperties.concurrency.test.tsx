...
vi.mock("../api/access", () => ({ accessApi: { getCurrentBoardAccess: vi.fn().mockResolvedValue({}) } }));
...
function primedClient() {
  ...
  client.setQueryData(
    ...
    buildCurrentBoardAccess({ features: { enableIsolatedWorkspaces: true, enableManagedSandboxOnly: true } }),
  );
  return client;
}
