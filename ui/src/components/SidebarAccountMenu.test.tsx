...
describe("SidebarAccountMenu", () => {
  ...
  it("keeps authenticated self-hosted sign-out on the local auth flow", async () => {
    ...
    // Self-hosted authenticated sign-out stays in the SPA: only truly
    // cloud-managed tenants (health.cloud set) get routed to the harness
    // logout page; this instance has no `cloud` metadata, so it just
    // invalidates the auth-dependent caches in place.
