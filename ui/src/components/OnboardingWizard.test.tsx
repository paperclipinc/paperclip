...
// Open the wizard directly on Step 4 ("Connect a model") for an existing
// company so the adapter/model pickers render without driving through the
// earlier company-creation steps.
vi.mock("../context/DialogContext", () => ({
  useDialog: () => ({
    onboardingOpen: true,
    onboardingOptions: { initialStep: 4, companyId: "company-1" },
...
describe("OnboardingWizard managed experience", () => {
