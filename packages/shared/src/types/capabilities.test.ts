...
describe("derivePublicFeatureFlags", () => {
  it("derives the full allowlist with safe defaults", () => {
    expect(
      ...
      enableStreamlinedLeftNavigation: defaultExperimental.enableStreamlinedLeftNavigation,
      enableChatConnectors: defaultExperimental.enableChatConnectors,
      enableAgentChat: defaultExperimental.enableAgentChat,
