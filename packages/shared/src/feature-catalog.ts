...
export const INSTANCE_FEATURE_CATALOG: Record<InstanceFeatureKey, FeatureCatalogEntry> = {
  ...
  cloudBilling: {
    title: "Cloud Billing",
    description:
      "Fork-only (paperclip.inc cloud): expose the cloud billing surfaces (subscription state, checkout entry points) in the app UI.",
    tier: "managed",
    cloudDefault: false,
    selfHostedDefault: false,
  },
  cloudTrialBanner: {
    ...
    description:
      "Fork-only (paperclip.inc cloud): show the trial status banner for companies on an active cloud trial.",
    tier: "managed",
    cloudDefault: false,
    selfHostedDefault: false,
  },
