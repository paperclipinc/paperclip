...
const MIGRATION_FILES = [
  "0191_status_cards.sql",
  "0192_status_card_compile_provenance.sql",
  "0193_status_card_pending_change_hash.sql",
  "0194_status_card_generation_issue_index.sql",
  "0195_status_card_agent.sql",
] as const;
