...
const migrations = [
  "0243_pink_fantastic_four.sql", "0244_conscious_adam_destine.sql",
  "0245_wide_lightspeed.sql", "0246_sleepy_metal_master.sql", "0247_organic_meltdown.sql", "0248_misty_nightshade.sql",
