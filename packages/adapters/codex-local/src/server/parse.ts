...
// instead of a generic retry-storming failure. The bare-401 alternatives are
// anchored to api.openai.com so unrelated 401s (e.g. a tool the agent ran
// against some other service) are not swallowed.
