...
// credential in play. This narrower pattern exists to let a caller upgrade
// that soft "please log in" bucket into a hard rejection when the message
// specifically says the key/token is invalid.
