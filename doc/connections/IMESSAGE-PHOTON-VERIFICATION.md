...
CI and review results. The Photon migration is `0278_easy_dragon_man.sql`, regenerated after master added its own 0277 agent-chat migration. Greptile reviewed the implementation commit at 5/5 with no
...
and regenerating migration 0278, all 16 integration cases passed at code commit
